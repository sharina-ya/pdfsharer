...
SECRET_KEY = 'django-insecure-uj0t=r7gurse6&u!ge0m9dyf2^zk=vblcs(05j3t38bkloqk1^'
...
WSGI_APPLICATION = 'pdfsharer.wsgi.application'
...
ASGI_APPLICATION = 'pdfsharer.asgi.application'
CHANNEL_LAYERS = {
    'default': {
